// Type definitions for Simple HTML Tokenizer version 0.2.1
...
declare module simpleHTMLTokenizer {
  ...
  export const HTML5NamedCharRefs: HTML5NamedCharRefsInterface;

  export class EntityParser {
    named: { [key: string]: string };

    constructor(named: { [key: string]: string });
    parse(): string | void;
  }
  ...
  export class EventedTokenizer {
    ...
    constructor(delegate: Tokenizer, entityParser: EntityParser);
    reset(): void;
  ...
  export class Tokenizer {
    ...
    startLine: number;
    startColumn: number;
    options: TokenizerOptionsInterface;
    tokenizer: EventedTokenizer;

    constructor(entityParser: EntityParser, options?: TokenizerOptionsInterface);
    tokenize(input: string): TokenInterface[];
    tokenizePart(input: string): TokenInterface[];
    tokenizeEOF(): TokenInterface;
    reset(): void;
    addLocInfo(): void;
    beginData(): void;
