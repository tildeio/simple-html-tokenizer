...
Tokenizer.prototype = {
  ...
  addLocInfo: function(_lastLine, _lastColumn) {
    var lastLine = (_lastLine === undefined) ? this.line : _lastLine;
    var lastColumn = (_lastColumn === undefined) ? this.column : _lastColumn;

    var token = this.token;
    token.firstLine = this.startLine;
    token.firstColumn = this.startColumn;
    token.lastLine = lastLine;
    token.lastColumn = lastColumn;

    this.startLine = lastLine;
    this.startColumn = lastColumn;
  },
